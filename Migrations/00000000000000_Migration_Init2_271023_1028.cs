...
{
    public partial class Migration_Init2_271023_1028 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"ALTER VIEW [dbo].[API_V_RELEVE]
				...
				ISNULL(co.CO_Nom,'') + ' '+ISNULL(co.CO_Prenom,'') CO_Nom,
				ct.CT_Intitule,
				ct.CT_Ville,
				de.DE_Intitule,
				ca.CA_Intitule
				...
				LEFT JOIN F_COLLABORATEUR co ON (ISNULL(a.CO_No,0) != 0 AND co.CO_No = ISNULL(a.CO_No,0)) OR (ISNULL(a.CO_No,0) != 0 AND ct.CO_No = co.CO_No)
