...
{
    public partial class Migration_Init5_100224_1257 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"CREATE VIEW API_V_REGLECH
                                    AS
                                    SELECT a.RG_No
                                          ,a.DR_No
                                          ,a.DO_Domaine
                                      ...
                                      LEFT JOIN F_DOCENTETE do ON a.DO_Type = do.DO_Type AND a.DO_Piece = do.DO_Piece
                                      LEFT JOIN F_COMPTET ct ON do.DO_Tiers = ct.CT_Num");
