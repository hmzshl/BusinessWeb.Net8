...
namespace BusinessWeb.Controllers
{
    ...
    public class BoldReportsAPIController : ControllerBase, IReportController
    {
        ...
        public void OnInitReportOptions(ReportViewerOptions reportOption)
        {
            ...
            // Here, we have loaded the sales-order-detail.rdl report from the application folder wwwrootResources. sales-order-detail.rdl should be in the wwwrootResources application folder.
            System.IO.FileStream inputStream = new System.IO.FileStream(basePath + @"
esources" + reportOption.ReportModel.ReportPath + ".rdl", System.IO.FileMode.Open, System.IO.FileAccess.Read);
