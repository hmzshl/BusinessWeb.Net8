...
namespace BusinessWeb.Models.DB
{
    ...
    {
        public F_PROTECTIONCIAL()
        {
            F_EPROTECTIONCIAL = new HashSet<F_EPROTECTIONCIAL>();
            InversecbPROT_UserProfilNavigation = new HashSet<F_PROTECTIONCIAL>();
        }
        ...
        public virtual ICollection<F_EPROTECTIONCIAL> F_EPROTECTIONCIAL { get; set; }
        public virtual ICollection<F_PROTECTIONCIAL> InversecbPROT_UserProfilNavigation { get; set; }
    }
}